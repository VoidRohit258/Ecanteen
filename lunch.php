...
<tr> <td colspan="2" align="center"> <div align="center" style="font-weight: bold; font-family: Verdana, Arial, Helvetica, sans-serif; color: #0000CC; font-style: italic">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 28px">Lunch/Dinner</span></div></td>
</tr>
<tr align="center">
<td width="39%" align="right"><strong>veg Lunch    </strong><strong> @70Rs</strong> <input type="checkbox" name="t1" value="veg Lunch" /><input style="width:5%" type="number" value="1" name="q1" id="q1" min="1" max="5"> </td>
<td width="39%" align="right"><strong>Veg  Spl Lunch </strong><strong>@120Rs</strong><input name="t2" type="checkbox" id="t2" value="Veg  Spl Lunch" /><input style="width:5%" type="number" value="1" name="q2" id="i2" min="1" max="5"></td>
</tr>
<tr align="center">
<td align="right"><strong>Veg biryani @80 Rs</strong><input name="t3" type="checkbox" id="t3" value="Veg biryani" /><input style="width:5%" type="number" value="1" name="q3" id="i3" min="1" max="5"></td>

<td width="39%" align="right"><strong>Dal Rice @50 Rs</strong><input name="t4" type="checkbox" id="t4" value="Dal Rice" /><input style="width:5%" type="number" value="1" name="q4" id="i4" min="1" max="5"></td>
</tr>
<tr align="center">
<td align="right"><strong> Roti Bhaji @40 Rs</strong><input name="t5" type="checkbox" id="t5" value=" Roti Bhaji" /><input style="width:5%" type="number" value="1" name="q5"  id="i5" min="1" max="5"></td>
<td width="39%" align="right"><strong>Dal Tadka @80 Rs </strong><input name="t6" type="checkbox" id="t6" value="Dal Tadka" />
<input style="width:5%" type="number" value="1" name="q6"  id="i6" min="1" max="5"></td>
</tr>

<tr align="center">
    <td align="right"><strong>Kadai Panner @150 Rs </strong><input name="t7" type="checkbox" id="t7" value="Kadai Panner" /><input style="width:5%" type="number" value="1" name="q7" id="i7" min="1" max="5"></td>
<td width="39%" align="right"><strong>Missal pav @100 Rs </strong><input name="t8" type="checkbox" id="t8" value="Missal pav" /><input style="width:5%" type="number" value="1" name="q8"  id="i8" min="1" max="5"></td>
</tr>


<tr align="center">
<td width="39%" align="right"><strong>Dum Alu- Masala @130 Rs </strong><input type="checkbox" name="t9" id="t9" value="Vada pav"  /><input style="width:5%" type="number" value="1" name="q9" min="1"  id="i9" max="5"></td>
<td width="39%" align="right"><strong>Aloo Kobi-Dry @130 Rs </strong>  <input type="checkbox" name="t10" id="t10" value="Kanda bhaji" /><input style="width:5%" type="number" value="1" name="q10"  id="i10" min="1" max="5"></td>

</tr>


<tr align="center">
<td width="39%" align="right"><strong>BabyCorn Mashroom  Masala@140 RS </strong><input name="t11" type="checkbox" id="t11" value="tandoori chicken" /><input style="width:5%" type="number" value="1" name="q11"  id="i11">
</td>
<td width="39%" align="right"><strong>Veg Kolhapuri @130 Rs </strong><input name="t12" type="checkbox" id="t12" value="Sandwich" /><input style="width:5%" type="number" value="1" name="q12" min="1"  id="i12" max="5"></td>
</tr>

<tr align="center">
<td width="39%" align="right"><strong>Veg Makhani @140 Rs </strong><input name="t13" type="checkbox" id="t13" value="Chilli toast" /><input style="width:5%" type="number" value="1" name="q13" min="1" max="5" id="i13"></td>
<td width="39%" align="right"><strong>Non Veg Lunch @110 RS </strong><input name="t14" type="checkbox" id="t14" value="sprite 500ml" /><input style="width:5%" type="number" value="1" name="q14"  id="i14" min="1" max="5"></td>
</tr>
<tr align="center">
